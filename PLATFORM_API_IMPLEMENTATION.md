...
### 1. Правильные endpoints v0 Platform API

Текущая реализация пробует несколько вариантов:
- `https://api.v0.dev/v1/projects`
- `https://v0.dev/api/v1/projects`
- `https://api.v0.dev/v1/platform/projects`

**Нужно проверить в документации v0.dev правильные endpoints!**

### 2. Формат запросов и ответов

Текущая реализация использует предположительные форматы:
- Создание проекта: `{ name, description }`
- Создание чата: `{ name }`
- Итерация: `{ content, role, message }`

**Нужно проверить правильный формат в документации!**
...
### 4. Формат ответа Platform API

Текущая реализация ищет код в:
- `responseData.code`
- `responseData.content`
- `responseData.message?.content`

**Нужно проверить реальный формат ответа!**
